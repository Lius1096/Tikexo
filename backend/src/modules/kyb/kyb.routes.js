...
// rôle admin) est vérifiée dans le service, pas ici par rôle. Relaie le
// fichier en flux (voir s3.js#envoyerFichier) — jamais d'URL présignée.
router.get('/documents/:id/fichier', ctrl.getFichierDocument);
