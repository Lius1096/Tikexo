...
router.post('/recharger', autoriser('ADMIN_DIRECTEUR', 'ADMIN_RH', 'GESTIONNAIRE_RH', 'SUPER_ADMIN', 'ADMIN_OPS'), checkRechargementLimit, ctrl.recharger);
router.post('/crediter-benef', autoriser('ADMIN_DIRECTEUR', 'ADMIN_RH', 'GESTIONNAIRE_RH'), ctrl.crediterBenef);
router.post('/crediter-groupe', autoriser('ADMIN_DIRECTEUR', 'ADMIN_RH', 'GESTIONNAIRE_RH'), ctrl.crediterGroupe);
